...
gem 'ngannotate-rails', git: 'git@github.com:kikonen/ngannotate-rails.git', tag: 'v0.15.4a'
...
gem 'gi_album_engine', git: 'git@github.com:kikonen/gi_album_engine.git', branch: 'cleanup_logic'
